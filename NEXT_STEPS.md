...
- Opening a list automatically places its current share link in the browser address bar, making it directly copyable when the app is hosted on GitHub Pages; leaving the list restores the normal app URL.
